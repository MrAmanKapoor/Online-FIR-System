...
<br>
			<form id="btn" style="width:auto;float:left;" action="" method="GET">
						<input id="btn" style="width:auto;float:left;"class="content"type="text"placeholder="Enter Case Date"  	name="date" value="">
						<input id="btn" style="width:auto;float:left;"class="content"type="text"placeholder="Enter Case Status"  	name="sts" value="">
...
$query="SELECT * FROM new_complaint WHERE date='$date' && status='$status'";
$result=mysqli_query($conn,$query);
